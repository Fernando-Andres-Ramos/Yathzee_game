...
class FullHouse extends Rule {
  evalRoll = dice =>{
    const condition1 = this.freq(dice).some(c=>c===3)
    const condition2 = this.freq(dice).some(c=>c===2)
    return condition1&&condition2? this.score : 0
  } 
}
...
const threeOfKind = new SumDistro({ count: 3 , description:"Score sum of all dice when there is a 3-of-kind"});
const fourOfKind = new SumDistro({ count: 4 , description:"Score sum of all dice when there is a 4-of-kind"});
